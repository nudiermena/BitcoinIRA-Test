...
namespace BitcoinIRA.Testing
{
    public class RecipeIngredientTests
    {
        ...
        {
            _calculatorRepository = new CalculatorRepository(_mockRecipeRepository.Object);
        }
        ...
        public void Calculate_ValidArguments_Succeeds()
        {
            ...
            List<RecipeResponse> recipeResponse = _calculatorRepository.CalculateAllRecipes();
